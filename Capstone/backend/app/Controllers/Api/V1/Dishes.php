...
class Dishes extends BaseController
{
     ...
     *     tags={"Dishes"},
     *     summary="List dishes",
     *     description="Returns the dish collection in the standard data/meta/links envelope. Accessible to admin, dapur, and gudang users. Runtime accepts paginate, page, perPage, q, search, sortBy, sortDir, created_at_from, created_at_to, updated_at_from, and updated_at_to. Unknown query parameters return HTTP 400.",
     *     security={{"bearerAuth":{}}},
     ...
     *     tags={"Dishes"},
     *     summary="Create dish",
     *     description="Creates a new dish master row. Accessible to admin and dapur users. Dish names are trimmed before persistence and active duplicate names are rejected with HTTP 400 validation errors.",
     *     security={{"bearerAuth":{}}},
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
     ...
     *     tags={"Dishes"},
     *     summary="Delete dish",
     *     description="Deletes a dish row. Accessible to admin and dapur users. Runtime blocks deletion while the dish is still referenced by dish compositions or menu slots and returns HTTP 400 with a validation error on dish_id.",
     *     security={{"bearerAuth":{}}},
     ...
     *     @OA\Response(response=400, description="Validation failed because the dish is still referenced.", @OA\JsonContent(ref="#/components/schemas/ValidationErrorResponse")),
     *     @OA\Response(response=401, description="Missing or invalid bearer token.", @OA\JsonContent(ref="#/components/schemas/MessageResponse")),
     *     @OA\Response(response=403, description="Authenticated user lacks the admin or dapur role required for this write operation.", @OA\JsonContent(ref="#/components/schemas/MessageResponse")),
     *     @OA\Response(response=404, description="Dish not found.", @OA\JsonContent(ref="#/components/schemas/MessageWithOptionalErrorsResponse")),
