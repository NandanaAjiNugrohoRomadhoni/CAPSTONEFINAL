...
class ItemSeeder extends Seeder
{
    public function run()
    {
        ...
        $items = [
            // PENGEMAS
            ['cat' => 'PENGEMAS', 'name' => 'Sendok Puding',         'unit' => 'pack', 'qty' => 0,    'min_stock' => 2],
            ['cat' => 'PENGEMAS', 'name' => 'Plastik Opp 14x14',     'unit' => 'pcs',  'qty' => 0,   'min_stock' => 5],
            ['cat' => 'PENGEMAS', 'name' => 'Plastik Opp 11x11',     'unit' => 'pcs',  'qty' => 0,   'min_stock' => 5],
            ['cat' => 'PENGEMAS', 'name' => 'Tusuk Gigi',            'unit' => 'pack', 'qty' => 0,    'min_stock' => 2],
            ['cat' => 'PENGEMAS', 'name' => 'Gelas Kertas',          'unit' => 'pack', 'qty' => 0,   'min_stock' => 5],
            ['cat' => 'PENGEMAS', 'name' => 'Sarung Tangan Plastik', 'unit' => 'pack', 'qty' => 0,    'min_stock' => 2],
            ['cat' => 'PENGEMAS', 'name' => 'Mika Buah Kotak',       'unit' => 'pack', 'qty' => 0,    'min_stock' => 3],
            ['cat' => 'PENGEMAS', 'name' => 'Tisu Makan',            'unit' => 'pack', 'qty' => 0,    'min_stock' => 3],
            ['cat' => 'PENGEMAS', 'name' => 'Sendok Plastik',        'unit' => 'pack', 'qty' => 0,    'min_stock' => 2],
            ['cat' => 'PENGEMAS', 'name' => 'Cup Puding Plastik',    'unit' => 'pack', 'qty' => 0,    'min_stock' => 2],
            ['cat' => 'PENGEMAS', 'name' => 'Plastik 0.25 Kg',       'unit' => 'pcs',  'qty' => 0,   'min_stock' => 5],
            ['cat' => 'PENGEMAS', 'name' => 'Plastik 0.5 Kg',        'unit' => 'pack', 'qty' => 0,   'min_stock' => 5],
            ['cat' => 'PENGEMAS', 'name' => 'Mika 7c/Mini Tart',     'unit' => 'pack', 'qty' => 0,    'min_stock' => 2],
            ['cat' => 'PENGEMAS', 'name' => 'Garpu Buah',            'unit' => 'pack', 'qty' => 0,    'min_stock' => 2],
            ['cat' => 'PENGEMAS', 'name' => 'Sterofoam',             'unit' => 'pack', 'qty' => 0,    'min_stock' => 2],
            ['cat' => 'PENGEMAS', 'name' => 'Cup Kertas Kue Lumpur', 'unit' => 'pack', 'qty' => 0,    'min_stock' => 2],
            ['cat' => 'PENGEMAS', 'name' => 'Gelas 10 Oz',           'unit' => 'pack', 'qty' => 0,    'min_stock' => 3],
            ['cat' => 'PENGEMAS', 'name' => 'Plastik 2 Kg',          'unit' => 'pcs',  'qty' => 0,   'min_stock' => 5],
            ['cat' => 'PENGEMAS', 'name' => 'Sendok Bebek Plastik',  'unit' => 'pack', 'qty' => 0,    'min_stock' => 2],
            ['cat' => 'PENGEMAS', 'name' => 'Plastik Cup Sealer',    'unit' => 'pcs',  'qty' => 0,    'min_stock' => 3],
            ['cat' => 'PENGEMAS', 'name' => 'Plastik Clip',          'unit' => 'pack', 'qty' => 0,    'min_stock' => 2],
            ...
            // BASAH
            ['cat' => 'BASAH', 'name' => 'Bakso Sapi',      'unit' => 'bks', 'qty' => 0,   'min_stock' => 5],
            ...
            ['cat' => 'BASAH', 'name' => 'Telur',           'unit' => 'kg',  'qty' => 0, 'min_stock' => 10],
            ...
            // KERING
            ['cat' => 'KERING', 'name' => 'Beras',                            'unit' => 'kg',      'qty' => 0,  'min_stock' => 50],
            ['cat' => 'KERING', 'name' => 'Tepung Beras',                     'unit' => 'kg',      'qty' => 0, 'min_stock' => 5],
            ['cat' => 'KERING', 'name' => 'Tepung Terigu',                    'unit' => 'kg',      'qty' => 0, 'min_stock' => 5],
            ['cat' => 'KERING', 'name' => 'Tepung Panir',                     'unit' => 'kg',      'qty' => 0,    'min_stock' => 3],
            ['cat' => 'KERING', 'name' => 'Tepung Kanji 500gr',               'unit' => 'kg',      'qty' => 0,  'min_stock' => 3],
            ['cat' => 'KERING', 'name' => 'Tepung Bumbu',                     'unit' => 'pcs',     'qty' => 0,    'min_stock' => 3],
            ['cat' => 'KERING', 'name' => 'Tepung Maezena',                   'unit' => 'kg',      'qty' => 0,    'min_stock' => 3],
            ['cat' => 'KERING', 'name' => 'Tepung Hungkwe',                   'unit' => 'bungkus', 'qty' => 0,   'min_stock' => 5],
            ['cat' => 'KERING', 'name' => 'Gula Pasir',                       'unit' => 'kg',      'qty' => 0,  'min_stock' => 10],
            ['cat' => 'KERING', 'name' => 'Gula Merah',                       'unit' => 'kg',      'qty' => 0, 'min_stock' => 5],
            ['cat' => 'KERING', 'name' => 'Minyak Goreng',                    'unit' => 'liter',   'qty' => 0,   'min_stock' => 10],
            ['cat' => 'KERING', 'name' => 'Lada Bubuk',                       'unit' => 'sachet',  'qty' => 0,  'min_stock' => 10],
            ['cat' => 'KERING', 'name' => 'Kemiri',                           'unit' => 'kg',      'qty' => 0,    'min_stock' => 3],
            ['cat' => 'KERING', 'name' => 'Ketumbar Bubuk',                   'unit' => 'sachet',  'qty' => 0,   'min_stock' => 5],
            ['cat' => 'KERING', 'name' => 'Garam Halus',                      'unit' => 'pcs',     'qty' => 0,   'min_stock' => 10],
            ['cat' => 'KERING', 'name' => 'Garam Lososa',                     'unit' => 'pcs',     'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Kecap Manis',                      'unit' => 'sachet',  'qty' => 0,  'min_stock' => 20],
            ['cat' => 'KERING', 'name' => 'Air Mineral Gelas Alqodiri',       'unit' => 'dus',     'qty' => 0,   'min_stock' => 5],
            ['cat' => 'KERING', 'name' => 'Susu Dancow',                      'unit' => 'kg',      'qty' => 0,    'min_stock' => 3],
            ['cat' => 'KERING', 'name' => 'Susu Hepatosol',                   'unit' => 'kotak',   'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Susu Diabetasol',                  'unit' => 'kotak',   'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Susu Neprisol',                    'unit' => 'kotak',   'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Susu Neocate',                     'unit' => 'kaleng',  'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Susu Proten',                      'unit' => 'kotak',   'qty' => 0,   'min_stock' => 5],
            ['cat' => 'KERING', 'name' => 'Susu Entrasol Platinum',           'unit' => 'kaleng',  'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Susu Lactogen Llf',                'unit' => 'kaleng',  'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Susu Sgm Ananda Gain 0-12',        'unit' => 'kotak',   'qty' => 0,   'min_stock' => 3],
            ['cat' => 'KERING', 'name' => 'Susu Sgm Gain Optigrow 1+',        'unit' => 'kotak',   'qty' => 0,   'min_stock' => 3],
            ['cat' => 'KERING', 'name' => 'Susu Neprisol D',                  'unit' => 'kaleng',  'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Susu S26',                         'unit' => 'kaleng',  'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Susu Lactogen Premature',          'unit' => 'kaleng',  'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Gula Diabetasol',                  'unit' => 'kotak',   'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Bihun',                            'unit' => 'bungkus', 'qty' => 0,    'min_stock' => 3],
            ['cat' => 'KERING', 'name' => 'Makaroni',                         'unit' => 'kg',      'qty' => 0,  'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Santan Kara',                      'unit' => 'pcs',     'qty' => 0,   'min_stock' => 5],
            ['cat' => 'KERING', 'name' => 'Saus Tomat Delmonte',              'unit' => 'jurigen', 'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Teh Celup Sariwangi',              'unit' => 'kotak',   'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Sp',                               'unit' => 'sachet',  'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Baking Powder',                    'unit' => 'sachet',  'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Fermipan',                         'unit' => 'sachet',  'qty' => 0,    'min_stock' => 3],
            ['cat' => 'KERING', 'name' => 'Margarin',                         'unit' => 'kaleng',  'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Choco Chip',                       'unit' => 'kg',      'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Meses',                            'unit' => 'kg',      'qty' => 0, 'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Vanili',                           'unit' => 'sachet',  'qty' => 0,  'min_stock' => 10],
            ['cat' => 'KERING', 'name' => 'Agar-Agar Warna Putih',            'unit' => 'sachet',  'qty' => 0,   'min_stock' => 3],
            ...
            ['cat' => 'KERING', 'name' => 'Sagu Mutiara',                     'unit' => 'pcs',     'qty' => 0,   'min_stock' => 3],
            ['cat' => 'KERING', 'name' => 'Sirup Marjan Cocopandan',          'unit' => 'botol',   'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Sirup Marjan Melon',               'unit' => 'botol',   'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Susu Kental Manis Putih Indomilk', 'unit' => 'kaleng',  'qty' => 0,    'min_stock' => 2],
            ...
            ['cat' => 'KERING', 'name' => 'Butter Krim',                      'unit' => 'kg',      'qty' => 0, 'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Kismis',                           'unit' => 'kg',      'qty' => 0,    'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Coklat Bubuk',                     'unit' => 'kg',      'qty' => 0,  'min_stock' => 2],
            ['cat' => 'KERING', 'name' => 'Kacang Hijau',                     'unit' => 'kg',      'qty' => 0,  'min_stock' => 3],
