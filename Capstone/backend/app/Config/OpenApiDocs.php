...
class OpenApiDocs extends BaseConfig
{
    ...
    public array $sourceFiles = [
        ...
        APPPATH . 'OpenApi/ReportsSchemas.php',
        ...
        APPPATH . 'OpenApi/StockOpnameSchemas.php',
        ...
        APPPATH . 'Controllers/Api/V1/Reports.php',
        APPPATH . 'Controllers/Api/V1/StockTransactions.php',
        APPPATH . 'Controllers/Api/V1/StockOpnames.php',
