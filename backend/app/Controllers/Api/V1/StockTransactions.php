...
class StockTransactions extends BaseController
{
     ...
     *     @OA\Response(response=201, description="Revision created with pending approval state.", @OA\JsonContent(ref="#/components/schemas/StockTransactionRevisionSubmitResponse")),
     *     @OA\Response(response=400, description="Validation failed for forbidden fields, unknown fields, invalid details, duplicate items, invalid input_unit, pending-sibling conflicts, or invalid parent state.", @OA\JsonContent(ref="#/components/schemas/ValidationErrorResponse")),
     *     @OA\Response(response=401, ref="#/components/responses/UnauthorizedMessageResponse"),
     *     @OA\Response(response=403, description="Authenticated user lacks the admin or gudang role required by the route group.", @OA\JsonContent(ref="#/components/schemas/MessageResponse")),
