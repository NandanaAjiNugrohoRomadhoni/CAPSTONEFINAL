 ...
 *     @OA\Property(property="item_unit_base", type="string", nullable=true, example="gram"),
 *     @OA\Property(property="item_unit_convert", type="string", nullable=true, example="kg"),
 *     @OA\Property(property="target_date", type="string", nullable=true, example="2026-03-01"),
 *     @OA\Property(property="current_stock_qty", type="number", format="float", example=100),
 ...
 *     @OA\Property(property="target_date_start", type="string", nullable=true, example="2026-03-01"),
 *     @OA\Property(property="target_date_end", type="string", nullable=true, example="2026-03-02"),
 *     @OA\Property(property="target_dates", type="array", @OA\Items(type="string", example="2026-03-01")),
 *     @OA\Property(property="estimated_patients", type="integer", example=105),
