...
export default function GiziMenuManagementPage() {
      ...
      {modalMode && modalMode !== "delete" ? (
        <div className="fixed inset-0 z-[90] flex items-center justify-center bg-[rgba(15,23,42,0.28)] px-4 py-6 backdrop-blur-sm">
          <div className="flex max-h-[92vh] w-full max-w-[780px] flex-col overflow-hidden rounded-[28px] bg-white shadow-[0_32px_90px_rgba(15,23,42,0.28)]">
            ...
            <div className="space-y-5 overflow-y-auto px-6 py-6">
              ...
              <div className="overflow-visible rounded-[22px] border border-[#D8E3F8] bg-[#F8FBFF]">
                ...
                <div className="space-y-4 p-5 overflow-visible">
                  {(modalMode === "detail" ? selectedMenu?.ingredients ?? [] : ingredients).map((row) => (
                    ...
                    >
                      <div className="grid gap-3 md:grid-cols-[1.5fr_1fr_auto] md:items-end">
                          ...
                          {modalMode === "detail" ? (
                            ...
                            <div className="flex items-center gap-2">
                              <input
                                ...
                                className="h-14 w-full rounded-2xl border border-[#D8E3F8] bg-white px-4 text-[15px] text-[#16213E] outline-none transition focus:border-[#2563EB] focus:ring-2 focus:ring-[#DBEAFE]"
                              />
                              <span className="min-w-[24px] text-sm text-[#94A3B8]">{row.unit ?? "-"}</span>
                            </div>
                          )}
                        </div>
                        ...
                        {modalMode !== "detail" ? (
                          <button
                            className="flex h-14 w-14 items-center justify-center rounded-2xl border border-[#D8E3F8] text-[#94A3B8] transition hover:border-red-200 hover:bg-red-50 hover:text-red-500"
                  ...
                  {modalMode !== "detail" ? (
                    <button
                      className="flex h-14 w-full items-center justify-center gap-2 rounded-2xl border border-dashed border-[#2563EB] bg-white text-[15px] font-semibold text-[#2563EB] transition hover:bg-[#F8FBFF]"
            ...
            <div className="flex items-center justify-end gap-3 border-t border-[#E8EEF8] px-6 py-5">
              <MiniActionButton
                onClick={closeModal}
                className="rounded-2xl border border-[#BFDBFE] px-6 py-3 text-[15px] font-semibold text-[#2563EB] hover:bg-[#EFF6FF]"
              >
                {modalMode === "detail" ? "Tutup" : "Batal"}
              </MiniActionButton>
              {modalMode !== "detail" ? (
                <PrimaryAction className="rounded-2xl px-6 py-3 text-[15px] font-semibold" onClick={() => void saveMenu()}>
                  Simpan
                </PrimaryAction>
              ) : null}
            </div>
