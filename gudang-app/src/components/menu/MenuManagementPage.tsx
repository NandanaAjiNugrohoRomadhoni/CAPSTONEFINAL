...
export default function MenuManagementPage({ mode }: Readonly<MenuManagementPageProps>) {
          ...
          <div className="flex items-center justify-between border-t bg-[#F8FAFC] px-5 py-4 text-sm text-[#94A3B8]">
            ...
            <div className="flex items-center gap-2">
              ...
              {Array.from({ length: totalPages }, (_, index) => index + 1).map((page) => (
                <button
                  key={page}
                  className={`flex h-9 min-w-9 items-center justify-center rounded-xl px-3 text-sm font-semibold transition ${currentPage === page
