...
export default function Page() {
  ...
  function handleExport() {
    ...
    const html = buildSpreadsheetDocument({
      ...
      subtitle: "Rekapitulasi data stok bahan berdasarkan filter stok bahan saat ini.",
      body: `
        <table class="section-gap">
          ...
          <tr class="no-border">
            <td class="subtitle" colspan="7">Rekapitulasi data stok bahan berdasarkan filter stok bahan saat ini.</td>
          </tr>
        </table>
        ...
        <table>
          ...
          ${tableRows || `<tr><td class="muted" colspan="7">Belum ada data stok bahan.</td></tr>`}
        </table>
      `,
    });
