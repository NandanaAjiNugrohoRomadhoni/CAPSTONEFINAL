        ...
        {activeTab === "basah" ? (
          <div className="rounded-2xl border border-gray-200 bg-white shadow-sm">
            ...
            <div className="space-y-5 p-5">
              <div>
                ...
                <input
                  ...
                  placeholder="0"
                  className={`mt-3 h-12 w-full rounded-xl border border-gray-200 px-4 text-base font-semibold text-gray-700 outline-none focus:ring-2 focus:ring-blue-500 ${basahTableLocked ? "cursor-not-allowed bg-slate-100 text-slate-500" : ""
                    }`}
                />
              </div>
            ...
            <div className="flex justify-end gap-3 border-t border-gray-100 bg-[#F9FAFB] p-5">
              ...
              >
                {saving ? "Menyimpan..." : basahTableLocked ? "Sudah Disimpan" : "Simpan"}
              </button>
            </div>
          </div>
        ) : (
    ...
    <div ref={wrapperRef} className={`relative ${className} ${open ? "z-50" : "z-20"}`}>
      <div className="relative">
        <input
          ...
          className={`h-11 w-full rounded-xl border border-slate-200 bg-white px-4 pr-10 text-sm text-slate-700 outline-none transition focus:border-[#2563EB] focus:ring-2 focus:ring-[#DBEAFE] ${disabled ? "cursor-not-allowed bg-slate-100 text-slate-500" : ""
            }`}
